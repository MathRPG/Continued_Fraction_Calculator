...
class Ui_ContinuedFractionCalculatorMainWindow(object):
    def setupUi(self, ContinuedFractionCalculatorMainWindow):
        ...
        self.expression_line_edit.setPlaceholderText("e.g. sqrt(pi), e ** e, sqrt(2) + sqrt(3), etc.")
        ...
        self.depth_slider.setMaximum(41)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.depth_slider)
        ...
        self.numerators_sequence_line_edit.setPlaceholderText("e.g. 1, 2, 1, 5")
        ...
        self.numerators_cycle_line_edit.setPlaceholderText("e.g. 1, 2")
